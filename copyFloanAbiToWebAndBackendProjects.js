...
const HARDHAT_ARTIFACT_DEFAULT_PATH_FOR_FLOAN_CONTRACT = './floan-contract/artifacts/contracts/Floan.sol/Floan.json';
const FLOAN_BACKEND_ABIS_PATH = './floan-backend/abis/Floan.json';
// note: by default create-react-app doesn't allow import outside of `src`, let's stick with that
const FLOAN_WEB_ABIS_PATH = './floan-web/src/abis/Floan.json';
